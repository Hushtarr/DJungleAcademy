...
//    public ResponseEntity<ApiInfo<Void>> addNewLesson(@ModelAttribute("Lesson") LessonDTO lessonDTO) {
//        lessonService.save(lessonDTO);
//        return ResponseEntity
//                .status(HttpStatus.OK)
//                .body(ApiInfo.successVoid("Lesson added"));
//    }
//
...
//
//    @PostMapping("/login")
//    public ResponseEntity<ApiInfo<String>> login(@RequestBody UserDTO userDTO) {
//
...
//        return ResponseEntity
//                .status(HttpStatus.OK)
//                .body(ApiInfo.successReturn("Login successful", token));
//
//    }
//
//}
